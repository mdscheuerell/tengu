...
The time series from WDFW begins in 1970 and runs through 2015, but the Tengy Derby data is missing size information for 2015, so we restricted our analysis to the 45 years from 1970-2014. Again, we fit models to the log-transformed size data.
...
```{r plot_size_metrics, fig.dim = c(6, 6), echo = FALSE, eval = FALSE}
