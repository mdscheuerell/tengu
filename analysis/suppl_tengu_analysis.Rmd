...
late_aicc <- c(size_both_1u$AICc, size_both_1b$AICc,
              size_both_2u$AICc, size_both_2b$AICc)
vec_aicc <- c(full_aicc - min(full_aicc),
              late_aicc - min(late_aicc))

## table of AICc values
tbl_aicc <- data.frame(bias = rep(c("No", "Yes"), 3),
                       states_i = c(1, 1, 2, 2, 1, 1),
                       obs_j = c(1, 1, 2, 2, 2, 2),
