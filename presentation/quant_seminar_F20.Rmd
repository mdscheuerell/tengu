...
# Comparison of derby & survey catch data
...
# Comparison of derby & survey size data
...
```{r plot_both_sizes, fig.dim = c(9, 6), echo = FALSE}
...
```{r plot_ssm_one_size, fig.dim = c(9, 6), echo = FALSE}
par(mai = c(0.9, 1.1, 0.1, 0.1), cex.axis = 1.5, cex.lab = 1.8)
matplot(yy, type = "l", lty = "solid", lwd = 1, col = c("dodgerblue", "indianred"),
        ylab = "Mean size (kg)", xlab = "Year", xaxt = "n")
...
.blue-text[
## Tengu anglers and WDFW surveys seem to be sampling different groups of fish
